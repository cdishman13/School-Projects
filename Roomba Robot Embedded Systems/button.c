...
uint8_t button_getButton() {
    ...
    short button6 = ((GPIO_PORTE_DATA_R & 0b00100000) == 0b00100000);
    short button5 = ((GPIO_PORTE_DATA_R & 0b00010000) == 0b00010000);
    short button4 = ((GPIO_PORTE_DATA_R & 0b00001000) == 0b00001000);
    short button3 = ((GPIO_PORTE_DATA_R & 0b00000100) == 0b00000100);
    short button2 = ((GPIO_PORTE_DATA_R & 0b00000010) == 0b00000010);
    short button1 = ((GPIO_PORTE_DATA_R & 0b00000001) == 0b00000001);
